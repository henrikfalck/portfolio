    ...
    <section className="about-page">
      <div className="content">
        <p>
          ...
          tegneblokker er gått gjennom, og bygging med Lego var et daglig
          rituale i barndommen. Det var ikke før jeg begynte på medier og
          ...
          hjemmekokt CSS som ikke fungerte fordi jeg hadde glemt å importere det
          (tok meg faktisk et par dager å finne ut den delen), klassenavn og
          id-er på norsk og selectors som ikke eksisterte andre plasser enn i
          hodet mitt.
          <br />
          <br />
